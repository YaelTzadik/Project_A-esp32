...
<div class="main-controls">
  <table>
    <tr>
      ...
      <td><center><input type="button" id="saveImage" value="TAKE IMAGE"></center></td>
...
<div class="container">
  <div class = "row">
    <div class = "column">
      <div class="section">
        <div class ="video-container">
          ...
          <center><img id="ShowImage2" src="" style="display:none"></center>
    ...
    <div class = "column">
      ...
      <div class="section">
        <canvas id="textCanvas" width="480" height="180" style= "border: 1px solid"></canvas>
...
<script>
  ...
  saveImage.onclick = function (event) {
    clearInterval(myTimer);
    myTimer = setInterval(function(){error_handle();},5000);
    ShowImage2.src=location.origin+'/?saveImage='+Math.random();
  }
  ...
  ShowImage2.onload = function (event) {
    //alert("SHOW IMAGE");
    console.log("SHOW iMAGE");
    clearInterval(myTimer);
    restartCount=0;
