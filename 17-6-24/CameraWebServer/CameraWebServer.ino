...
// void startSDCardMount();

// bluetooth to wifi vars
...
const char* bluetooth_name = "DoorLockControler";

long start_wifi_millis;
long wifi_timeout = 1000;
...
void setup() {
  ...
  preferences.putString("pref_ssid", "0");
  preferences.putString("pref_pass", "0");
  wifi_stage = NONE;
...
{
  SerialBT.println("already found vaible wifi");
  if (event == ESP_SPP_SRV_OPEN_EVT) {
